...
const TechnologyItem = React.memo(({ tech }) => {
  ...
  return (
    <div className="bg-primary p-6 lg:p-8 rounded-md text-white text-center flex flex-col items-center justify-center shadow-lg transition-transform transform hover:scale-105">
      {tech.icon}
