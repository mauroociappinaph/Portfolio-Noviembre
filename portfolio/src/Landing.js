  ...
  return (
    <>
      <Nav>
        ...
        <Link to="about-me" smooth={true} duration={500}>Acerca de mí</Link>
        <Link to="soft-skills" smooth={true} duration={500}>Habilidades blandas</Link>
        <Link to="technologies" smooth={true} duration={500}>Tecnologías</Link>
